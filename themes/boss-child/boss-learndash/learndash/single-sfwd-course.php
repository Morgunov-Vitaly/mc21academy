            ...
            <article id="post-<?php the_ID(); ?>" <?php post_class(); ?>>
                ...
                <section id="course-details">
                    <span class="course-statistic">
                        ...
                        if ($total_lessons) {
                            /* mvv */
                            echo 'Кол-во уроков курса: ' . number_format_i18n($total_lessons); 
                        }
...
//                                if (trim($course_status) != 'Not Started' && trim($course_status) != 'Completed' && trim($course_status) != 'Изучен' && trim($course_status) != 'Не начат') {
//                                    echo '<i class="fa fa-spinner"></i>';
//                                }
                                switch (trim($course_status)) {
                                    case 'Not Started':
