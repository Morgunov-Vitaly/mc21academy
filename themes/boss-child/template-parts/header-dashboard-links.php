<div id="dashboard-links" class="bp_components mvv-here">
    <ul>
        <?php if (is_multisite()): ?>
        ...
        <?php 
            else: /* is_multisite() не мультисайт */
              /* проверить возможности роли  */  
        ...
        <?php 
                endif; /* current_user_can('create_users') */
            endif; /* is_multisite() else */
        ?>
    </ul>
</div>