...
<div id="buddypress">
	 ...
	 * "D:\Рабочая\XXI век\IDE\plugins\buddypress\bp-templates\bp-legacy\buddypress\members\register.php"
	 * @since 1.1.0
	 */
	do_action( 'bp_before_register_page' ); ?>

	<div class="page mvv-register" id="register-page">
		...
		<?php if ( 'request-details' == bp_get_current_signup_step() ) : ?>
			...
			<div class="register-section" id="basic-details-section">
				...
				<h2><?php _e( 'Account Details', 'buddypress' ); ?></h2>
                                ...
                                <label for="signup_username"><?php _e( 'Username', 'buddypress' ); ?> - <span class="mv-comments">латинскими буквами</span> <?php _e( '(required)', 'buddypress' ); ?></label>
				<?php
                                /* Логин может содержать только латинские буквы, пробелы, подчёркивания, дефисы, точки и символ @ */    
				/**
