		...
		<p id="message-recipients">
			<span class="highlight">
				...
				<?php endif; ?>
                        ...
                        <!--  MV changes добавляем кнопку Ответить  -->
			<a class="button mv_reply" href="#send-reply"><?php _e( 'Reply', 'buddypress' ); ?></a>&nbsp;&nbsp;
			<a class="button confirm mv_delete" href="<?php bp_the_thread_delete_link(); ?>"><?php _e( 'Delete', 'buddypress' ); ?></a>
