...
//if bp-followers activated then show it.
                ...
                <div id="item-statistics">
		            ...
		            <span>
                                <p><?php $points = badgeos_get_users_points(bp_displayed_user_id());
                                $user_course_points   = learndash_get_user_course_points( bp_displayed_user_id() );
                                echo('B: '); echo number_format($points); echo('| L: '); echo number_format($user_course_points); ?></p>
