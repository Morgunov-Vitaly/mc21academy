...
<?php if ( bp_has_members( bp_ajax_querystring( 'members' ) ) ) : ?>
	...
	?>
		...
		<li>
			...
			<div class="item">
				<div class="item-title"> <!-- mvv changes добавляем ID пользователя   -->
					<a href="<?php bp_member_permalink(); ?>"><?php bp_member_user_id(); ?>. <?php bp_member_name(); ?></a>
				</div>
